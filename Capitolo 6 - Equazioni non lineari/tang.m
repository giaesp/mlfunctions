...
% (o di Newton-Raphson).
%
% Prototipo: [x,convg,iter,err] = tang(f,d,x3,int_toll,zero_toll,max_iter,v_mode,g_mode)
% Input:     La funzione f
%            La derivata d di f
...
function [x,convg,iter,err] = tang(f,d,x3,int_toll,zero_toll,max_iter,v_mode,g_mode)
