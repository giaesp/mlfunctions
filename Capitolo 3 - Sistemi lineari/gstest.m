% Funzione: gstest
% ----------------
% Stabilisce se il metodo di Gauss-Seidel converge alla soluzione esatta del
% sistema lineare Ax = b di cui è data la matrice A
% 
% Prototipo: [bool,iter] = gstest(A,m)
...
function [bool,iter,B,rs] = gstest(A,m)
